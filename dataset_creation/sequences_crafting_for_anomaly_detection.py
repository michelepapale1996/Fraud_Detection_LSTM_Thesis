...
def get_sequences(transactions, look_back):
    ...
    while pointer < len(genuine_transactions.index) - look_back:
        ...
        try:
            ...
            next_transaction.append(transactions.iloc[i + 1][cols + ["isFraud"]])
            sequences.append(sequence.values)
        except Exception as e:
            print(e)
        pointer += 1
    return sequences, next_transaction
...
np.save("/home/mpapale/thesis/anomaly_detection/dataset_" + str(look_back) + "_lookback/x.npy", x)
np.save("/home/mpapale/thesis/anomaly_detection/dataset_" + str(look_back) + "_lookback/y.npy", y)
print("Done.")